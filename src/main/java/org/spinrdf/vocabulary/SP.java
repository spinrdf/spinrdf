...
public class SP {
    ...
    public final static Resource Lateral = ResourceFactory.createResource(NS + "Lateral");
    ...
    private static void init(Personality<RDFNode> p) {
        ...
        p.add(Lateral.class, new SimpleImplementation(Lateral.asNode(), LateralImpl.class));
